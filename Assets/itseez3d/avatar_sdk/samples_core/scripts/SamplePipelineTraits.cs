...
namespace ItSeez3D.AvatarSdkSamples.SamplePipelineTraits
{
	public abstract class SampleHead2AbstractTraits : PipelineTypeSampleTraits
	{
		...
		{
			return BASE_GENERATED_HAIRCUT_SHORT;
		}
	}
	...
	public class SampleHead2Traits : SampleHead2AbstractTraits
	{
		...
		public override Vector3 GettingStartedSampleLocalPosition { get { return new Vector3(0.0f, 0.04f, 0.0f); } }
	}
	...
	public class SampleFaceTraits : PipelineTypeSampleTraits
	{
		...
		public override Vector3 ViewerDisplayScale { get { return new Vector3(10, 10, 10); } }
	...
	public abstract class PipelineTypeSampleTraits : PipelineTypeTraits
	{
		...
		public abstract Vector3 ViewerDisplayScale { get; }
		public virtual Vector3 ViewerLocalPosition { get { return new Vector3(0.0f, 0.0f, 0.0f); } }
		public virtual Vector3 GettingStartedSampleDisplayScale { get { return new Vector3(1.0f, 1.0f, 1.0f); } }
		public virtual Vector3 GettingStartedSampleLocalPosition { get { return new Vector3(0.0f, 0.0f, 0.0f); } }
